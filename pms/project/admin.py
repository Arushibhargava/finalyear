...
class TeamAdmin(admin.ModelAdmin):
    list_display = ('team_id', 'team_name')  # Display these fields in the admin list view
    search_fields = ('team_id', 'team_name')  # Add search functionality for these fields
admin.site.register(Team,TeamAdmin)

class CoordinatorAdmin(admin.ModelAdmin):
    list_display = ('coord_name', 'c_email', 'phone_no')
    search_fields = ('coord_name', 'c_email')
admin.site.register(Coordinator,CoordinatorAdmin)


class MentorAdmin(admin.ModelAdmin):
    list_display = ('m_email', 'mentor_name', 'phone_no', 'c_email')
...
class TeamMemberAdmin(admin.ModelAdmin):
    ...
    search_fields = ('stu_id', 'member_name', 'email', 'team_name')  # Add search functionality
    list_filter = ('branch', 'semester', 'team_id')  # Add filters for these fields
